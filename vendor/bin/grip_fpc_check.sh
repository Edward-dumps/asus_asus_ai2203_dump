...
echo "1 1" > /sys/class/leds/vibrator/asus_haptic_trig_control
setprop vendor.grip.vib.trig1.en 1
echo "2 1" > /sys/class/leds/vibrator/asus_haptic_trig_control
setprop vendor.grip.vib.trig2.en 1
