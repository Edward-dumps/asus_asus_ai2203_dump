...
#echo "[MSP430][Load_Cal_Data] Load /vendor/factory/mcu_close_cal" > /dev/kmsg
#mcu_close_cal=`cat /vendor/factory/mcu_close_cal`
#fi

#if [ -e /vendor/factory/mcu_open_cal ] ; then
#echo "[MSP430][Load_Cal_Data] Load /vendor/factory/mcu_open_cal" > /dev/kmsg
...
if [ -e /mnt/vendor/persist/mcu_close_cal ] ; then
	...
	echo "[MSP430][Load_Cal_Data] Copy /vendor/factory/mcu_close_cal to /mnt/vendor/persist/" > /dev/kmsg
	cp /vendor/factory/mcu_close_cal /mnt/vendor/persist/mcu_close_cal
	chown system:system /mnt/vendor/persist/mcu_close_cal
	chmod 666 /mnt/vendor/persist/mcu_close_cal
	mcu_close_cal=`cat /mnt/vendor/persist/mcu_close_cal`
fi
...
if [ -e /mnt/vendor/persist/mcu_open_cal ] ; then
	...
	echo "[MSP430][Load_Cal_Data] Copy /vendor/factory/mcu_open_cal to /mnt/vendor/persist/" > /dev/kmsg
	cp /vendor/factory/mcu_open_cal /mnt/vendor/persist/mcu_open_cal
	chown system:system /mnt/vendor/persist/mcu_open_cal
	chmod 666 /mnt/vendor/persist/mcu_open_cal
	mcu_open_cal=`cat /mnt/vendor/persist/mcu_open_cal`
fi
