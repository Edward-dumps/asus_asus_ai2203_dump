...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/Settings$NfcSettingsPageActivity;,
        Lcom/android/settings/Settings$ScreenShotActivity;,
        Lcom/android/settings/Settings$BluetoothPairingDetailActivity;,
        Lcom/android/settings/Settings$AppDashboardActivity;,
        Lcom/android/settings/Settings$MediaControlsSettingsActivity;,
        Lcom/android/settings/Settings$DetectAbnormalDrainAppActivity;,
        Lcom/android/settings/Settings$OneHandModeGestureSensitivityActivity;,
        Lcom/android/settings/Settings$OneHandModeActivity;,
        Lcom/android/settings/Settings$EmergencyDisclaimerFragment;,
        Lcom/android/settings/Settings$EmergencyGestureSettingsActivity;,
        Lcom/android/settings/Settings$USBTypeSettingsActivity;,
        Lcom/android/settings/Settings$NaviBarSettingsDashboardFragment;,
        Lcom/android/settings/Settings$GDPR16YearsNotifyFragment;,
        Lcom/android/settings/Settings$FrameRatePreferenceActivity;,
        Lcom/android/settings/Settings$FingerprintSensorIndicatorSettingsActivity;,
        Lcom/android/settings/Settings$FingerprintSensorAnimationSettingsActivity;,
        Lcom/android/settings/Settings$FlipCameraFeaturesActivity;,
        Lcom/android/settings/Settings$FlipCameraSoundSettingsActivity;,
        Lcom/android/settings/Settings$DoubleTapRetractActivity;,
        Lcom/android/settings/Settings$AsusNavigationThreeBtnAdvancedDashboardActivity;,
        Lcom/android/settings/Settings$AsusSupportSettingsDashboardActivity;,
        Lcom/android/settings/Settings$AsusAdvancedSettingsDashboardActivity;,
        ...
        Lcom/android/settings/Settings$RestoreConfirmActivity;,
        Lcom/android/settings/Settings$RestoreActivity;,
        ...
        Lcom/android/settings/Settings$LocalBackupActivity;,
        Lcom/android/settings/Settings$LocalBackupSuggestionActivity;,
        Lcom/android/settings/Settings$ChangeFontSizeAndScreenZoomActivity;,
        Lcom/android/settings/Settings$ToggleFontSizeActivity;,
        Lcom/android/settings/Settings$ChangeFontSizeAndScreenZoomSuggestionActivity;,
        Lcom/android/settings/Settings$SmartFontSizeSuggestionActivity;,
        Lcom/android/settings/Settings$SmartReadingSuggestionActivity;,
