...
.method private static buildPreferenceControllers(Landroid/content/Context;Landroid/app/Activity;Lcom/android/settingslib/core/lifecycle/Lifecycle;Lcom/android/settings/development/DevelopmentSettingsDashboardFragment;Lcom/android/settings/development/BluetoothA2dpConfigStore;)Ljava/util/List;
    ...
    .line 513
    new-instance v1, Lcom/android/settings/development/AsusHdcpCheckingPreferenceController;

    invoke-direct {v1, p0}, Lcom/android/settings/development/AsusHdcpCheckingPreferenceController;-><init>(Landroid/content/Context;)V
    ...
    .line 542
    new-instance p1, Lcom/android/settings/development/SoftApOcvPreferenceController;

    invoke-direct {p1, p0}, Lcom/android/settings/development/SoftApOcvPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 543
    new-instance p1, Lcom/android/settings/development/SoftApBeaconProtectionPreferenceController;

    invoke-direct {p1, p0}, Lcom/android/settings/development/SoftApBeaconProtectionPreferenceController;-><init>(Landroid/content/Context;)V
    ...
    .line 547
    new-instance p1, Lcom/android/settings/development/WifiWhitelistRoamingPreferenceController;

    invoke-direct {p1, p0}, Lcom/android/settings/development/WifiWhitelistRoamingPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 548
    new-instance p1, Lcom/android/settings/development/WifiNewNetworkAutoConnectionPreferenceController;

    invoke-direct {p1, p0}, Lcom/android/settings/development/WifiNewNetworkAutoConnectionPreferenceController;-><init>(Landroid/content/Context;)V
    ...
    .line 619
    new-instance p1, Lcom/android/settings/development/PowerSaverDevPreferenceController;

    invoke-direct {p1, p0, p2}, Lcom/android/settings/development/PowerSaverDevPreferenceController;-><init>(Landroid/content/Context;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 620
    new-instance p1, Lcom/android/settings/development/ZRamEnablePreferenceController;

    invoke-direct {p1, p0}, Lcom/android/settings/development/ZRamEnablePreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 621
    new-instance p1, Lcom/android/settings/development/LiquidDectionPreferenceController;

    invoke-direct {p1, p0}, Lcom/android/settings/development/LiquidDectionPreferenceController;-><init>(Landroid/content/Context;)V
...
.method private handleQsTileLongPressActionIfAny()V
    ...
    const-class v2, Lcom/android/settings/development/WirelessDebuggingPreferenceController;
    ...
    check-cast v2, Lcom/android/settings/development/WirelessDebuggingPreferenceController;

    .line 257
    invoke-virtual {v2}, Lcom/android/settings/development/WirelessDebuggingPreferenceController;->isAvailable()Z
    ...
    .line 263
    :cond_2
    const-class v1, Lcom/android/settings/development/qstile/DevelopmentTiles$OneHandMode;
    ...
    .line 271
    :cond_3
    const-class v1, Lcom/android/settings/development/qstile/DevelopmentTiles$GloveMode;
...
.method public onSwitchChanged(Landroid/widget/Switch;Z)V
    ...
    invoke-virtual {v0}, Lcom/asus/commonresx/widget/MainSwitchBar;->getSwitch()Landroid/widget/Switch;
